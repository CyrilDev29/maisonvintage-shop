 ...
 *
 * Garde anti-redéclaration :
 * - Évite la fatale "Cannot declare enum App\Enum\OrderStatus, because the name is already in use"
 *   si le fichier est, pour une raison quelconque, chargé deux fois (autoload/preload exotic…).
 */
if (!\enum_exists(__NAMESPACE__ . '\OrderStatus', false)) {
